...
from datasets import TransformerConf2Dataset
from models import TransformerConf2, LightningModelTransformerConf2
...
def main():
    ...
    train_set = TransformerConf2Dataset(config=config, split="train")
    val_set = TransformerConf2Dataset(config=config, split="val")
    ...
    # Initialise model
    model = TransformerConf2(num_encoder_layers=args.encoder_layers,
    ...
    lightning_model = LightningModelTransformerConf2(model=model,
                                                     lr=args.lr,
                                                     beta1=args.beta1,
                                                     beta2=args.beta2,
