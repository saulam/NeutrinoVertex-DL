...
Description: Training script for the proton conditional normalizing flow.
"""
...
def main():
    ...
    val_set = CNFDataset(args, split="val")
    val_loader = DataLoader(val_set, collate_fn=val_set.collate_fn, batch_size=args.batch_size,
                            num_workers=args.num_workers, shuffle=False)

    # Create lightning model
    lightning_model = LightningModelCNF(img_shape = (args.img_size, args.img_size, args.img_size), 
    ...
    callbacks = []
    monitored_losses = ['val_loss','train_loss']
