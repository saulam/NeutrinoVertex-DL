...
def args_transformer(version=1):
    ...
    parser.add_argument("-el", "--encoder_layers", type=int, default=4, help="number of encoder layers")
    parser.add_argument("-dl", "--decoder_layers", type=int, default=4, help="number of decoder layers")
    ...
    parser.add_argument("--cosine_annealing_steps", type=int, default=10, help="scheduler steps")
    ...
    parser.add_argument('-ws', '--warmup_steps', type=int, default=2, help='Maximum number of warmup steps')
