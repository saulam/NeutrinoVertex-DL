...
class TransformerConf3(nn.Module):
    def __init__(self,
        ...
        super(TransformerConf3, self).__init__()
    ...
    def encode(self, src: Tensor, exit_particle: Tensor, src_mask: Tensor, src_padding_mask: Tensor):
        """
        Encode the source sequence.

        Args:
            src (Tensor): Input source sequence.
            exit_particle (Tensor): Exit particle information.
        ...
        src_emb = self.src_emb(src_indexes, src_charges, exit_particle)
    ...
    def forward(self,
        ...
        """
        # Encode the source sequence
        memory, vertex_pos = self.encode(src, exit_particle, src_mask, src_padding_mask)
